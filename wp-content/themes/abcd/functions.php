...
function abcd_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'abcd' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'abcd_custom_background_args', array(
...
function abcd_scripts() {
	// ** Enqueue Google Fonts: Cabin, Open Sans
	wp_enqueue_style('abcd-gfont', 'https://fonts.googleapis.com/css?family=Cabin:400,400i,500,500i,600,600i,700,700i|Open+Sans|PT+Serif:400,400i,700&amp;subset=latin-ext');

	wp_enqueue_style( 'abcd-style', get_template_directory_uri() . '/assets/css/style.css' );

	wp_enqueue_script( 'abcd-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'abcd-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/skip-link-focus-fix.js', array(), '20151215', true );
